...
if XEBPlusLanguage == "en-US" then
    ...
    nSetLang[3] = "Don't show disc artwork in menu."
...
elseif XEBPlusLanguage == "es-419" then
    ...
    nSetLang[3] = "No mostrar la carátula del disco en el menú."
    ...
    nSetLang[8] = "Desactivar el arte del disco"
...
elseif XEBPlusLanguage == "pt-BR" then
    ...
    nSetLang[3] = "Não mostre a arte do disco no menu."
    ...
    nSetLang[8] = "Desativar Arte do Disco"
...
PluginData.Description = "v2.10 by sync-on-luma(Y)\n"..nSetLang[2];
