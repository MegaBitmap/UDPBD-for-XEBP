...
if XEBPlusLanguage == "en-US" then
    ...
    neuLang[21] = "Choose whether selected options will apply to\nall games, or just the current one."
    ...
    neuLang[34] = "Saving Configuration"
    ...
    neuLang[46] = "Loading Configuration"
    ...
    neuLang[57] = "GSM: Off"
    neuLang[58] = "Change Graphics Synthesizer mode"
    neuLang[59] = ".\nThe file may be missing or corrupted."
    neuLang[60] = "% complete."
    neuLang[61] = "\n100% complete."
    neuLang[62] = "Initializing Menu"
    ...
    neuLang[71] = "Starting "
    neuLang[72] = "Loading Recent Games"
...
elseif XEBPlusLanguage == "es-419" then
    ...
    neuLang[79] = "Modo de trama GSM:"
    neuLang[80] = "Modo de campo GSM:"
    neuLang[81] = "Inversión de campo GSM:"
    neuLang[82] = " Por defecto"
    neuLang[83] = "Lanzador neutrino (MMCE)"
    neuLang[84] = "Iniciar juegos desde un dispositivo MMCE con neutrino"
    neuLang[85] = " Tipo"
    neuLang[86] = " Progresivo"
    neuLang[87] = " 240p/288p"
    neuLang[88] = " 480p/576p"
    neuLang[89] = " Ninguno"
...
elseif XEBPlusLanguage == "pt-BR" then
    ...
    neuLang[79] = "Modo de quadro GSM:"
    neuLang[80] = "Modo de campo GSM:"
    neuLang[81] = "Inversão de campo GSM:"
    neuLang[82] = " Predefinição"
    neuLang[83] = "neutrino Launcher (MMCE)"
    neuLang[84] = "Lançar jogos de um dispositivo MMCE com neutrino"
    neuLang[85] = " Tipo"
    neuLang[86] = " Progressivo"
    neuLang[87] = " 240p/288p"
    neuLang[88] = " 480p/576p"
    neuLang[89] = " Nenhum"
    neuLang[90] = "neutrino Launcher (HDL)"
